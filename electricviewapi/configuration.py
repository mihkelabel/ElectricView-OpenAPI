...
from electricviewapi.http.requests_client import RequestsClient
...
class Configuration(object):
    ...
    environments = {
        Environment.PRODUCTION: {
            Server.SERVER_1: 'http://localhost:8000/api/auth',
            Server.SERVER_2: 'http://127.0.0.1:8000/api/analytics'
        }
    }
