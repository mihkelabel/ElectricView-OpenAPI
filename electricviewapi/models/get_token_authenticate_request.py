...
class GetTokenAuthenticateRequest(object):

    """Implementation of the 'Get Token/Authenticate Request' model.
    ...
    def __init__(self,
                 username=None,
                 password=None):
        """Constructor for the GetTokenAuthenticateRequest class"""
